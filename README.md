...
```bash
git clone https://github.com/justinwilliames/claude-calendar-review.git ~/code/claude-calendar-review
ln -s ~/code/claude-calendar-review ~/.claude/skills/calendar-review
```
